# springboot-sample serverless API
The springboot-sample project, created with [`aws-serverless-java-container`](https://github.com/awslabs/aws-serverless-java-container).
...
...
Mounting my.sample.service.StreamLambdaHandler::handleRequest (java8) at http://127.0.0.1:3000/{proxy+} [OPTIONS GET HEAD POST PUT DELETE PATCH]
...
```
    ...
    "Stacks": [
        {
            ...
            "Description": "AWS Serverless Spring API - my.sample.service::springboot-sample", 
            "Tags": [], 
            "Outputs": [
                {
                    "Description": "URL for application",
                    "ExportName": "SpringbootSampleApi",  
                    "OutputKey": "SpringbootSampleApi",
